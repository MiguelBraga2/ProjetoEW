...
exports.processFile = (file_name, current_id) => {
  const inputStream = fs.createReadStream('./fileProcessing/raw_files/' + file_name, 'utf8');
  const outputStream = fs.createWriteStream('./fileProcessing/processed_files/' + file_name, 'utf8');
